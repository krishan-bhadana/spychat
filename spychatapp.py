...
def signup():
    ...
    flag = 0          # flag sets when the account is successfully created and stops the loop for re-entering a username
...
print ("Hello, let's get started.")        # Program control starts here
