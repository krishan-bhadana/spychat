...
def add_status():
    ...
    if default.upper() == "N":
        ...
        if len(STATUS_MESSAGES) >= message_selection:                                     #to check of the status message selected is valid
...
def add_friend():
    ...
    new_friend.rating = float(new_friend.rating)                        #taking input and then converting it to the corresponding datatype
